...
tibble(paper_id = c("nflwar19", "goingdeep20", "nextgenscrapy20",
       ...
       status = "Published",
       pub_year = c(2019, 2020, 2020, 2020, 2020, 2019, 2020, 2020, 2021),
       pub_ranking = c(1, 3, 4, 5, 1, 2, 2, 2, 1),
       url = c("https://doi.org/10.1515/jqas-2018-0010",
               ...
               "https://doi.org/10.1093/bib/bbab329"),
...
tibble(paper_id = c("msi21", "issi20", "ucsas20", "jsm20_1",
                    ...
                    "ecots18_1", "ecots18_2"),
       # Invited talk titles
       title = c("Selective inference approaches for augmenting genetic association studies with multi-omics metadata",
                 "Adaptive approaches for augmenting genetic association studies with multi-omics covariates",
                 "Going Deep: models for continuous-time within-play valuation of game outcomes in american football with tracking data",
                 "Going Deep: models for continuous-time within-play valuation of game outcomes in american football with tracking data",
                 "Going Deep: models for continuous-time within-play valuation of game outcomes in american football with tracking data",
       ...
       author_notes = c(NA,
                        "Presented by Kathryn Roeder", "Keynote Speaker", "Presented by Lee Richardson",
                        NA, NA, NA,
                        ...
                        NA),
       conference = c("Center of Modeling, Simulation and Interactions (MSI) Seminar",
                      ...
                      "Symposium on Data Science & Statistics",
                      "eCOTS", "eCOTS"),
       presentation_type = c(rep("invited_talk", 11),
                             rep("contributed", 7),
                             rep("poster", 6),
                             rep("eposter", 4)),
       year = c(2021, 2020, 2020, 2020, 2019, 2017, 2017,
                2017, 2018, 2018, 2019,
                # contributed:
...
tibble(teaching_id = c("cmu_stats_315", "cmu_stats_462", "cmu_stats_350",
       ...
       title = c("Statistical Graphics and Visualization",
                 ...
                 "Machine Learning II",
                 rep("Summer Undergraduate Research Experience in Statistics", 2),
                 "Data Science Initiative",
                 "Statistical Graphics and Visualization"),
       year = c(2018, 2018, 2017, 2015, 2015, 2013, 2014, 2014,
                2015, 2015, 2018, 2018, 2019, 2019, 2019, 2021,
                2020, 2021, 2021, 2022),
       location = c(rep("Carnegie Mellon University", 14),
                    "Wharton School of the University of Pennsylvania",
                    rep("Carnegie Mellon University", 5)),
       semester = c("Summer", "Spring", "Fall", "Fall", "Spring", "Fall",
                    "Spring", "Fall", "Spring", "Fall", "Spring", "Fall",
                    "Fall", "Summer", "Summer",
                    "Spring",
                    "Summer", "Summer", "Fall","Spring"),
       notes = c(rep("Level: Undergrad", 8), rep("Instructor and created course materials in undergraduate student-taught course program", 2),
                 ...
                 "Level: Master of Science in Computational Finance (MSCF)",
                 rep("Assistant director and lead instructor of program, created course curriculum / materials, and advised student projects (http://www.stat.cmu.edu/cmsac/)", 2),
                 "PhD Project Fellow, advised two teams of undergrad students working with United States Olympic & Paralympic Committee",
                 "Instructor; Level: Undergrad"),
       role = c(rep("course_ta", 3), rep("course_grader", 2), rep("course_ta", 3),
                rep("course_instructor", 2),
                rep("workshop_instructor", 3), "research_advising",
                "workshop_instructor",
                "course_ta",
                rep("research_advising", 3), "course_instructor")) %>%
...
tibble(type = c("full", "intern", "intern", "intern",
       ...
       company = c("PNC Financial Services",
                   ...
                   "Zelus Analytics"),
       start_year = c(2016, 2015, 2014, 2013, 2021),
       end_year = c(2017, 2015, 2014, 2013, NA),
       location = c(rep("Pittsburgh, PA", 4), "Remote")) %>%
...
tibble(type = c("organize", "organize", "organize", "organize",
       ...
       service_for = c("Carnegie Mellon Sports Analytics Conference",
                       ...
                       "Journal of Business Analytics", "Communications in Statistics",
